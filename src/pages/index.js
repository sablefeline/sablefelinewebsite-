...
export default function Home() {
  const [hue, setHue] = useState(0); // State to manage hue value
        ...
        <Card sx={{ maxWidth: 600, margin: '0 auto' }}>
          <CardContent>
            ...
            <Grid container spacing={2}>
              <Grid item xs={6}>
                <Image 
                  ...
                  width={300} 
                  height={200} 
                  style={{ filter: `hue-rotate(${hue}deg)` }} // Apply hue rotation
                />
              </Grid>
              <Grid item xs={6}>
            ...
            <Slider 
              ...
              sx={{ mt: 4 }} 
            />
            <Typography variant="body2" sx={{background: "radial-gradient(circle, rgba(0,99,255,1) 0%, rgba(0,99,255,1) 44%, rgba(0,0,0,1) 100%)", borderRadius:"50px", color:"white", padding:"10px"}}>
              Cattest slider
            </Typography>
